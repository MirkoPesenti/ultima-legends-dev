...
export const preloadPartialTemplates = async function () {
	...
	return load([
		...
		`systems/${SYSTEM}/templates/app/parts/charactermancer-actor-attributes.hbs`,
